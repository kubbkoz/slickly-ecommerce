...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cms-block-image-highlight-row flex flex-col sm:flex-row justify-start items-start gap-6 w-full" }, _attrs))} data-v-53ba770d><div class="w-full sm:flex-1" data-v-53ba770d>`);
      _push(ssrRenderComponent(_component_CmsGenericElement, { content: unref(leftContent) }, null, _parent));
      _push(`</div><div class="w-full sm:flex-1" data-v-53ba770d>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@shopware/cms-base-layer/app/components/public/cms/block/CmsBlockImageHighlightRow.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CmsBlockImageHighlightRow = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-53ba770d"]]), { __name: "CmsBlockImageHighlightRow" });
