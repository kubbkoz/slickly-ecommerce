...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@shopware/cms-base-layer/app/components/public/cms/block/CmsBlockCategoryNavigation.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CmsBlockCategoryNavigation = Object.assign(_sfc_main, { __name: "CmsBlockCategoryNavigation" });

export { CmsBlockCategoryNavigation as default };
