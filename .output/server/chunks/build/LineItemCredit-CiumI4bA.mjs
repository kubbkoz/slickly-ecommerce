...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../vue-starter-template/app/components/account/order/LineItemCredit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const LineItemCredit = Object.assign(_sfc_main, { __name: "AccountOrderLineItemCredit" });

export { LineItemCredit as default };
