import { e as useShopwareContext, K as useNotifications, m as useI18n, b as useLocalePath, M as useInternationalization, c as useRouter, d as useRoute, L as __nuxt_component_0 } from './server.mjs';
...
import { defineComponent, ref, withAsyncContext, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const state = ref();
    try {
      const result = ([__temp, __restore] = withAsyncContext(() => apiClient.invoke(
        ...
        for (const errorItem of error.details.errors) {
          if (errorItem?.detail) {
            if (errorItem.code === "FRAMEWORK__INVALID_UUID") {
              ...
              [__temp, __restore] = withAsyncContext(() => router.push(formatLink("/account/address"))), await __temp, __restore();
            }
          }
        }
      }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_AccountPageHeader, {
              class: "mb-14",
              title: _ctx.$t("account.address.edit.header"),
              subtitle: _ctx.$t("account.address.edit.subHeader")
            }, null, _parent2, _scopeId));
            _push2(`<div class="mb-10"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AccountSectionHeader, {
              class: "mb-4",
              title: _ctx.$t("account.address.edit.personalDataSectionHeader")
            }, null, _parent2, _scopeId));
            if (unref(state)) {
            ...
            return [
              createVNode("div", null, [
                ...
                createVNode("div", { class: "mb-10" }, [
                  ...
                  unref(state) ? (openBlock(), createBlock(_component_AccountAddressForm, {
                    key: 0,
                    address: unref(state),
                    onHandleSubmit: handleSubmit
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../vue-starter-template/app/pages/account/address/edit/[id].vue");
