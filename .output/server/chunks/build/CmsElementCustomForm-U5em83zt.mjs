...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@shopware/cms-base-layer/app/components/public/cms/element/CmsElementCustomForm.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CmsElementCustomForm = Object.assign(_sfc_main, { __name: "CmsElementCustomForm" });

export { CmsElementCustomForm as default };
