...
import { Check, Loader2, Eye } from 'lucide-vue-next';
import __nuxt_component_2 from './AppModal-CMHCLJuP.mjs';

const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "WatchdogModal",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(state) === "success") {
              ...
              _push2(`</div><h3 class="font-tech font-bold uppercase text-lg mb-2"${_scopeId}>Stráženie aktivované</h3><p class="text-gray-500 text-sm font-sans mb-6"${_scopeId}>Budeme Vás informovať o zmene dostupnosti alebo ceny produktu.</p><button class="px-8 py-3 bg-black text-white font-tech font-bold uppercase tracking-widest text-sm hover:bg-brand transition-colors"${_scopeId}>Zavrieť</button></div>`);
            } else {
              _push2(`<!--[--><p class="text-sm text-gray-500 font-sans mb-6"${_scopeId}>Vyplňte údaje a budeme Vás informovať, keď sa zmení dostupnosť alebo cena produktu <strong class="text-black"${_scopeId}>${ssrInterpolate(__props.product?.name)}</strong>.</p><div class="space-y-4"${_scopeId}><div${_scopeId}><label class="form-label"${_scopeId}>Meno *</label><input${ssrRenderAttr("value", unref(name))} type="text" class="form-input w-full" placeholder="Vaše meno"${_scopeId}></div><div${_scopeId}><label class="form-label"${_scopeId}>Email *</label><input${ssrRenderAttr("value", unref(email))} type="email" class="form-input w-full" placeholder="vas@email.sk"${_scopeId}></div><div${_scopeId}><label class="form-label"${_scopeId}>Telefón</label><input${ssrRenderAttr("value", unref(phone))} type="tel" class="form-input w-full" placeholder="+421 ..."${_scopeId}></div>`);
              if (unref(variants).length > 1) {
                _push2(`<div${_scopeId}><label class="form-label"${_scopeId}>Variant</label><select class="form-input w-full"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(selectedVariant)) ? ssrLooseContain(unref(selectedVariant), "") : ssrLooseEqual(unref(selectedVariant), "")) ? " selected" : ""}${_scopeId}>Všetky varianty</option><!--[-->`);
              ...
              _push2(` ${ssrInterpolate(unref(state) === "loading" ? "Odosielam..." : "Aktivovať stráženie")}</button><!--]-->`);
            }
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "px-2 py-4" }, [
                unref(state) === "success" ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("h3", { class: "font-tech font-bold uppercase text-lg mb-2" }, "Stráženie aktivované"),
                  createVNode("p", { class: "text-gray-500 text-sm font-sans mb-6" }, "Budeme Vás informovať o zmene dostupnosti alebo ceny produktu."),
                  createVNode("button", {
                  ...
                  createVNode("p", { class: "text-sm text-gray-500 font-sans mb-6" }, [
                    createTextVNode("Vyplňte údaje a budeme Vás informovať, keď sa zmení dostupnosť alebo cena produktu "),
                  ...
                  createVNode("div", { class: "space-y-4" }, [
                    ...
                    unref(variants).length > 1 ? (openBlock(), createBlock("div", { key: 0 }, [
                      ...
                      withDirectives(createVNode("select", {
                        ...
                        createVNode("option", { value: "" }, "Všetky varianty"),
                    ...
                    createVNode("label", { class: "flex items-start gap-2 cursor-pointer" }, [
                      ...
                      createVNode("span", { class: "text-xs text-gray-500 font-sans" }, "Súhlasím so spracovaním osobných údajov za účelom notifikácie o dostupnosti produktu. *")
                    ])
                  ]),
                  ...
                  createVNode("button", {
                    ...
                    createTextVNode(" " + toDisplayString(unref(state) === "loading" ? "Odosielam..." : "Aktivovať stráženie"), 1)
                  ], 8, ["disabled"])
                ], 64))
              ])
            ];
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/product/WatchdogModal.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const WatchdogModal = Object.assign(_sfc_main, { __name: "WatchdogModal" });

export { WatchdogModal as default };
