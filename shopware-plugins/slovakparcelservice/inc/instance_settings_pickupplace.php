...
/*
 *  Instance settings for delivery to balikovo shipping method
 */
...
$instance_settings = array(
    'title' => array(
        ...
        'default'		=> __( 'Slovak Parcel Service delivery balíkovo', 'slovakparcelservice' ),
        'desc_tip'		=> true
    ),
    ...
    'costbyweight' => array(
        ...
        'type' 			=> 'hidden',
        'description'   => __('Max weight is ','slovakparcelservice') . strval(self::MAX_WEIGHT) . __('kg. Shipping cost without VAT','slovakparcelservice'),
        'desc_tip'		=> true
    ),
...
//     ),
    ...
    'delivery' => array(
        'title'  => __( 'Display Pickup Place of type', 'slovakparcelservice' ),
        'type'          => 'select',
        'class'         => 'wc-enhanced-select',
        'options'       => array(
            'pspt'   => __( 'Parcelterminal and Parcelshop', 'slovakparcelservice' ),
            'ps'     => __( 'Parcelshop', 'slovakparcelservice' ),
            'pt'     => __( 'Parcelterminal', 'slovakparcelservice' )
        )
    ),
