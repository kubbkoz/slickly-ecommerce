...
<template>
  <section class="py-16 md:py-24 bg-white">
    <div class="container mx-auto px-4 lg:px-8">
      <!-- Contained-width promo card (not full-bleed) — dark background image
           inside a rounded card, matching the site's "Vyberáme pre vás" block. -->
      <div
        class="relative overflow-hidden text-white rounded-default"
      ...
      >
        ...
        <div class="relative z-10 p-8 sm:p-10 md:p-16">
          <div class="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">

            <!-- Ľavý stĺpec — text -->
            <div class="lg:w-[45%] flex-shrink-0">
              <h2 class="text-2xl md:text-3xl font-black uppercase font-tech tracking-tight leading-tight mb-3">
