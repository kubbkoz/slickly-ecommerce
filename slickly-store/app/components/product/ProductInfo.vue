    ...
    <div class="flex flex-col mb-8 relative mt-6 md:mt-8 lg:mt-6">
      ...
      <div class="flex items-center gap-4">
          ...
          <div v-if="discountPercent > 0"
               class="relative group px-3 py-1 text-sm md:text-base font-black text-white uppercase tracking-wider font-tech bg-brand shadow-sm self-stretch flex items-center cursor-help">
             -{{ discountPercent }}%
