  ...
  <div class="w-full md:max-w-[1536px] md:mx-auto px-gutter md:px-grid-margin py-stack-lg md:py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-stack-lg md:gap-16">
      ...
      <div class="flex flex-col gap-stack-md">
        <div>
          <p class="font-technical-data text-technical-data text-on-surface-variant uppercase mb-stack-xs">
            {{ product.tags.join(' • ') }}
          </p>
        ...
        <div v-if="product.inStock" class="flex flex-col gap-stack-xs">
          ...
          <div class="flex gap-stack-sm">
            <button
              type="button"
              class="flex-1 h-12 bg-primary text-on-primary font-body-md text-body-md flex items-center justify-center gap-2 rounded-default cursor-pointer transition-opacity duration-200 hover:opacity-85 active:scale-[0.99] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
            ...
            <button
              type="button"
              class="flex-1 h-12 bg-surface-container-lowest text-on-surface-variant border border-outline-variant font-body-md text-body-md flex items-center justify-center gap-2 rounded-default cursor-pointer transition-opacity duration-200 hover:bg-surface-container-low active:scale-[0.99] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
    ...
    <!-- Popis -->
    <section v-reveal class="contain-section mt-stack-lg md:mt-section-padding-lg">
    ...
    <!-- Špecifikácia -->
    <section v-if="product.specifications.length" v-reveal class="contain-section mt-stack-lg md:mt-section-padding-lg">
      <h2 class="font-headline-md text-headline-md md:text-headline-lg uppercase tracking-tight border-b border-grid-line pb-stack-sm md:pb-6 mb-stack-md md:mb-8">
        Špecifikácia
      </h2>
    ...
    <!-- Použitie -->
    <section v-if="product.usage.length" v-reveal class="contain-section mt-stack-lg md:mt-section-padding-lg">
      <h2 class="font-headline-md text-headline-md md:text-headline-lg uppercase tracking-tight border-b border-grid-line pb-stack-sm md:pb-6 mb-stack-md md:mb-8">
        Použitie
      </h2>
    ...
    <LazyPdpReviews v-reveal hydrate-on-visible :product="product" :average-rating="averageRating" />

    <!-- Odporúčame k tomu -->
    <LazyPdpBundleSection v-if="bundleProducts.length" v-reveal hydrate-on-visible :main-product="product" :bundle-products="bundleProducts" />

    <!-- Podobné produkty -->
    <LazyPdpRelated v-if="related.length" v-reveal hydrate-on-visible :products="related" />
